    ...
    return(
        <>
            <button style={{position:'relative'}}>
                ...
                <p style={{position:'absolute',bottom:'5px',right:'5px',backgroundColor:'var(--mutedColor)',borderRadius:'6px',width:'fit-content',paddingLeft:'4px',paddingRight:'4px',color:'#000'}}>20</p>
            </button>    
        </>
    )
}
